...
typedef enum {
    ...
    DONE = 1,            ///< message with string (doesn't include trailing '\0')
    ACK = 2,             ///< empty message
    STOP = 3,            ///< empty message
    TRANSFER = 4,        ///< message with TransferOrder
    BALANCE_HISTORY = 5, ///< message with BalanceHistory
    CS_REQUEST = 6,      ///< empty message
    CS_REPLY = 7,        ///< empty message
    CS_RELEASE = 8       ///< empty message
} MessageType;
